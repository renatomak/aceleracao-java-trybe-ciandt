...
10.1 Introdução ao Spring e Spring Boot

- [X] [Camadas projeto Spring](https://github.com/renatomak/aceleracao-java-trybe-ciandt/tree/main/11-spring/acc-java-02-exercises-camadas-projeto-spring)

10.2 Spring - Injeção de Dependências e organização de uma aplicação Spring

- [X] [Sistema de Pagamentos](https://github.com/renatomak/aceleracao-java-trybe-ciandt/tree/main/10-java-web/acc-java-02-exercises-injecao-de-dependencias-sistema-pagamentos)
