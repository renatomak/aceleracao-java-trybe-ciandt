...
INSERT INTO milhas.LANCAMENTO (IDPESSOA, IDTIPOLANCAMENTO, IDPARCEIRO, VALOR, DATA)
VALUES (SELECT IDPESSOA FROM milhas.PESSOA WHERE login = 'huguinho', 1, NULL, 500, '2022-02-01');
INSERT INTO milhas.LANCAMENTO (IDPESSOA, IDTIPOLANCAMENTO, IDPARCEIRO, VALOR, DATA)
VALUES (SELECT IDPESSOA FROM milhas.PESSOA WHERE login = 'huguinho', 1, NULL, 33, '2022-02-01');
INSERT INTO milhas.LANCAMENTO (IDPESSOA, IDTIPOLANCAMENTO, IDPARCEIRO, VALOR, DATA)
